...
# initialize_app(cred, {'storageBucket': 'fingerprintdoorlock-8bb72.appspot.com'})

# os.environ["GOOGLE_APPLICATION_CREDENTIALS"]="fingerprintdoorlock-8bb72-firebase-adminsdk-6328x-e02a42aad0.json"
# firebase = firebase.FirebaseApplication('https://fingerprintdoorlock-8bb72.firebaseio.com/')
...
def sketch_transform(image):
    ...
    if rects.any():
        ...
        # blob = bucket.blob(timestr)
        # blob.upload_from_file(cv2.imwrite((timestr+'.jpg ') , image))
